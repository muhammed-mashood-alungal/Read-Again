...
function Addresses({ userAddresses, userId }) {
  ...
  const handleDefaultAddress = async (addressId, index) => {
    try {
      await axiosUserInstance.put(`/${userId}/address/change-default`, {
        addressId,
      });
      setAddresses((addresses) => {
        return addresses.map((address) => {
            ...
            return (
              <div className="tab__body ">
                <input
                  ...
                  onClick={(e) => {
                    handleDefaultAddress(address._id, index);
                  }}
                />{" "}
                &nbsp;
      ...
      {currentAction === "creating" && (
        <div className="p-3 address-div">
          ...
          <form className="form grid ">
            ...
            <input
              type="text"
              placeholder="Land mark , eg:near Hypermarket..."
              className="form__input"
              value={landmark}
              onChange={(e) => {
            ...
            <input
              ...
              onChange={(e) => {
                handlePhone(e.target.value, 0);
              }}
            />
            <p className="err-msg">
              {addressError?.phoneNumbers && addressError?.phoneNumbers[0]}
            </p>
            <input
              type="text"
              placeholder="Phone Number"
              ...
              onChange={(e) => {
                handlePhone(e.target.value, 1);
              }}
            />
            <p className="err-msg">
              {addressError?.phoneNumbers && addressError?.phoneNumbers[1]}
            </p>
          </form>
          <button className="primary-btn" role="submit" onClick={handleSubmit}>
            Save
          </button>
          <button
